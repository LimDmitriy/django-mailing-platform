...
urlpatterns = [
    path("subscribers/list", SubscriberListView.as_view(), name="subscriber_list"),
    path(
        "subscribers/create/", SubscriberCreateView.as_view(), name="subscriber_create"
    ),
    path(
        "subscribers/<int:pk>/detail/",
    ...
    path("my-mailings/", MailingStatsView.as_view(), name="user_mailings_stats"),
]
